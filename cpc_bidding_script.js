...
// TODAY, YESTERDAY, LAST_7_DAYS, LAST_14_DAYS
  ...
  while (rows.hasNext()) {
    ...
    row.CpcBid = newCpcValue(Criteria, CpcBid, FirstPageCpc, ImpShare, TOPImpShare);
...
function newCpcValue (Criteria, CpcBid, FirstPageCpc, ImpShare, TOPImpShare) {
  var cpc = CpcBid;
  ...
  Logger.log([Criteria, CpcBid, cpc, FirstPageCpc, ImpShare, TOPImpShare])
